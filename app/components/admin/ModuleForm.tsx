        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 border border-gray-300 rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-[#005696] placeholder-gray-300"
            />
            <FileUploader
          ...
          <p className="text-[11px] text-gray-400 mt-1">
            ...
            Link Google Drive, URL file langsung, atau upload file (PDF, DOC, ZIP, dll).
          </p>
        </div>
